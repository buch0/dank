...
class Rakuten {
  ...
  async cartIn() {
    ...
    urlObj.searchParams.set('units', $('[name="units"]').val());
  ...
  async buy() {
    ...
    if(url !== 'https://basket.step.rakuten.co.jp/rms/mall/bs/mdlvpay/?l2-id=step0_pc_purchase_top_1') {
      return;
    }
    this.log(url, 'yesyesy');
